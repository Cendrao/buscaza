(function(){
				...
				while (i < quantidadePaginas)
				{
					...
					request({
						...
						extrairDados(objJson).then(function(data){
							...
							listaImoveis.addRange( data);					

							retornos++;



							if (retornos == quantidadePaginas)
								resolveParse(listaImoveis);
	...
	function gerarDadosRequest(obj) {
		...
		var hashFragment = { precomaximo: obj.precoMaximo, parametrosautosuggest: [], pagina: obj.pagina };
